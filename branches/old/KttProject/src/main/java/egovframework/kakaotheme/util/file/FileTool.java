...
public class FileTool {
    ...
    public static long saveFile(InputStream is, File file) throws IOException {
		...
		try {
		    ...
		    while ((bytesRead = is.read(buffer, 0, (int)BUFFER_SIZE)) != -1) {
				size += bytesRead;
...
//            }
    ...
    */
    ...
    public static String parseOsSeparator(String path){
	...
	public static void createFolder(String folderPath) throws Exception{
		File folderFile = new File(FileTool.parseOsSeparator(folderPath));
		folderFile.mkdirs();
	}
	
	public static String getFileDataString(String absolutePath) throws Exception{
		StringBuffer sb = new StringBuffer();
		File manifestFile = new File(absolutePath);
		String line = "";
